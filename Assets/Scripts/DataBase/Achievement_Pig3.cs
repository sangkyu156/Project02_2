...
public class Achievement_Pig3 : MonoBehaviour
{
    ...
    {
        switch (AchievementManager.Instance.achievement04)
        {
            case 0:
        ...
        //if (AchievementManager.Instance.reward04 == false)
        //{
        //    switch (AchievementManager.Instance.achievement04)
        //    {
        //        case 0:
    ...
    public void Reward()
    {
        ...
        //AchievementManager.Instance.reward04 = true;
    }
